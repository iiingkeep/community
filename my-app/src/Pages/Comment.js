  ...
  return(
    <div className='Comment'>
      ...
      {commentLists && commentLists.map((comment) => (
        ...
        <SingleComment loggedIn={loggedIn} userid={userid} refreshFunction={refreshFunction} updateComment={updateComment} deleteComment={deleteComment} comment={comment}/>
        <ReplyComment loggedIn={loggedIn} userid={userid} refreshFunction={refreshFunction} updateComment={updateComment} deleteComment={deleteComment} parentCommentId={comment.commentid}  commentLists={commentLists} postId={id}/>
        </React.Fragment>
        )
      ))}
